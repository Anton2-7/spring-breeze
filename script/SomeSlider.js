class SomeSlider {
    ...
    constructor({ startIndex = 0,
        ...
        this.sliderWidth2 = document.querySelector('.sl-3').offsetWidth
        ...
        // console.log((this.root.offsetWidth * this.length))
        ...
        this.setBarOffset()
        //this.width = //вычисляешь на основе слайдов
    ...
    setSlide(index) {
        ...
        // this.sliderEkement.dispatChEvent(new Event(я переключил слайд...))
    ...
    setPositionByIndex = () => {
        ...
        this.currentTranslate = this.currentIndex * -this.sliderWidth2
    ...
    setBarOffset() {
        //   this.bar.style.transform = `translateX(${-this.someSlider.currentIndex * this.width}px)`

        this.bar.style.transform = `translateX(${this.offset}px)`
        //   this.bar.style.transform = `translateX(${-this.currentIndex * this.width}px)`
    }
